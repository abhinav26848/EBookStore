...
namespace EBookStore.Controllers
{
    public class BookController : Controller
    {
        ...
        private readonly IGenerService genreService;
        private readonly IPublisherService publisherService;
        public BookController(IBookService bookService, IGenerService genreService, IPublisherService publisherService, IAuthorService authorService)
        {
        ...
        public IActionResult Add(Book model)
        {
            ...
            model.GenreList = genreService.GetAll().Select(a => new SelectListItem { Text = a.Name, Value = a.Id.ToString(), Selected = a.Id == model.GenerId }).ToList();
